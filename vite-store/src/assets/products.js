...
const prod1 = new Product(
  ...
  900000,
  1,
  ['https://i.postimg.cc/kX8PKZpq/ipad.jpg', 'https://i.postimg.cc/jqBrWKvM/ipad2.jpg'],
...
const prod2 = new Product(
  ...
  800000,
  1,
  ['https://i.postimg.cc/jqBrWKvM/ipad2.jpg', 'https://i.postimg.cc/kX8PKZpq/ipad.jpg'],
  ['Silver', 'Space Gray', 'Gold'],
  true
);
...
const prod5 = new Product(
  ...
  400000,
  1,
  ['https://i.postimg.cc/WbcbB2MB/gopro12.png', 'https://i.postimg.cc/8k6zXFrd/gopro2.png'],
  ['Black'],
  false
);
const prod6 = new Product(
  ...
  300000,
  1,
  ['https://i.postimg.cc/8k6zXFrd/gopro2.png', 'https://i.postimg.cc/WbcbB2MB/gopro12.png'],
  ['Black'],
  false
);
...
const prod11 = new Product(
  ...
  750000,
  1,
  ['https://i.postimg.cc/HxGQcrcp/mock1.jpg', 'https://i.postimg.cc/Y91Q1tYQ/mock2.jpg'],
  ['Silver', 'Space Gray'],
  false
);
...
const prod19 = new Product(
  ...
  300000,
  1,
  ['https://i.postimg.cc/VstzWdJx/watch.jpg', 'https://i.postimg.cc/3N278cM8/watch1.jpg'],
...
const prod20 = new Product(
  ...
  100000,
  1,
  ['https://i.postimg.cc/3N278cM8/watch1.jpg', 'https://i.postimg.cc/VstzWdJx/watch.jpg'],
  ['Space Gray', 'Silver', 'Gold'],
  false
);
